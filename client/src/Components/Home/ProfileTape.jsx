...
export function ProfileTape() {
    ...
    return (
        <div className="bg-customOrange flex relative overflow-hidden xs:h-[29vw] xs:py-0 py-8">
            <div className="justify-center w-full xs:mb-0 mb-[2.5rem]  xs:w-[50%] flex-col py-[8%] px-[4%] xs:justify-start items-start gap-[10vw] xs:gap-[2vw] inline-flex">
            ...
            <img className="hidden xs:block absolute h-[28vw] right-[-3%] top-[3%]" src={reel_tape} alt="reel_tape" />
        </div>
    )
}
