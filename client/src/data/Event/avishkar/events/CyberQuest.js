// you have to import bg image
import CyberquestPic from "../images/Main/CYBERQUEST.webp";
import CyberSubPic from "../images/Sub/Cyberquest.webp";

const CyberQuest = {
  eventName: "CyberQuest",
  tagline: "",
  BGImageLink: CyberquestPic,
  instagramLink: "",
  events: [
    {
      eventName: "Insomnia",
