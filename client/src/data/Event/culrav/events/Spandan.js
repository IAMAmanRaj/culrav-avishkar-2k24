  ...
  events: [
    {
      ...
      eventId: "30",
      description:
        "Style that distinguishes you and Walk that gives you confidence. When we talk about Spandan, it all comes down to Fashion. So, let's celebrate the evolution of fashion through decades by taking part in this exhilarating event called Rampwalk.",
      rules: [
        {
    ...
    },
    {
      ...
      eventId: 111,
      description:
        "A dream is a picture of a possibility. We should have a strong heart and a prepared mind to turn that into reality. Ever wonder about earning the title of fashion icon for the day? Here we invite you to take part in this title event and seize the opportunity to become Mr. or Miss Spandan.",
      rules: [
