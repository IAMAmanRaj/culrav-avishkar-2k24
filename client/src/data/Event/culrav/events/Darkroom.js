    ...
    events: [
        {
            ...
            eventId: "1",
            description: "Unleash your inner storyteller by crafting an unforgettable tale through imagery. Depict a story based on the theme in a series of 5-10 pictures.",
            rules: [
        ...
        },
        {
            eventName: "Tasveer",
            eventId: "8",
            description: "Pick up your cameras to capture the essence of the moments and expressions to present that vivid imagery.",
            rules: [
        ...
        },
        {
            eventName: "Layers",
            eventId: "10",
            description: "Dissecting imagination with colors and fill them with colors of your imagination.",
            rules: [
        ...
        },
        {
            eventName: "B-Roll",
            eventId: "11",
            description: "This competition will put your videography and cinematography skills to test. Use your lens to tell a story and create a compelling narrative.",
            rules: [
        ...
        },
        {
            ...
            eventId: "12",
            description: "Fancy yourself as a film maker? Create a captivating narrative by using visuals and dialgues that will keep the audience engaged",
            rules: [
